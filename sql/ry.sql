...
-- ----------------------------
INSERT INTO `gen_table` VALUES ('3', 'sys_empl', '员工管理', null, null, 'SysEmpl', 'crud', 'com.ruoyi.system', 'system', 'empl', '员工管理', 'ruoyi', '0', '/', null, 'admin', '2020-07-31 16:57:28', '', null, null);
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='代码生成业务表字段';

-- ----------------------------
-- Records of gen_table_column
-- ----------------------------
INSERT INTO `gen_table_column` VALUES ('14', '3', 'sid', '员工主键', 'int(20)', 'Long', 'sid', '1', '1', null, '1', null, null, null, 'EQ', 'input', '', '1', 'admin', '2020-07-31 16:57:28', '', null);
INSERT INTO `gen_table_column` VALUES ('15', '3', 'sname', '姓名', 'varchar(255)', 'String', 'sname', '0', '0', '1', '1', '1', '1', '1', 'LIKE', 'input', '', '2', 'admin', '2020-07-31 16:57:28', '', null);
INSERT INTO `gen_table_column` VALUES ('16', '3', 'sage', null, 'int(10)', 'Integer', 'sage', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', '3', 'admin', '2020-07-31 16:57:28', '', null);
INSERT INTO `gen_table_column` VALUES ('17', '3', 'address', null, 'varchar(255)', 'String', 'address', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', '4', 'admin', '2020-07-31 16:57:28', '', null);
...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('RuoyiScheduler', 'Admin-PC1596187956522', '1596188230165', '15000');
...
-- ----------------------------
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', 'TASK_CLASS_NAME1', 'DEFAULT', null, '1596187960000', '-1', '5', 'PAUSED', 'CRON', '1596187956000', '0', null, '2', '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', 'TASK_CLASS_NAME2', 'DEFAULT', null, '1596187965000', '-1', '5', 'PAUSED', 'CRON', '1596187957000', '0', null, '2', '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME3', 'DEFAULT', 'TASK_CLASS_NAME3', 'DEFAULT', null, '1596187960000', '-1', '5', 'PAUSED', 'CRON', '1596187957000', '0', null, '2', '');
...
-- ----------------------------
-- Table structure for sys_empl
-- ----------------------------
DROP TABLE IF EXISTS `sys_empl`;
CREATE TABLE `sys_empl` (
  `sid` int(20) NOT NULL AUTO_INCREMENT COMMENT '员工主键',
  `sname` varchar(255) NOT NULL COMMENT '姓名',
  `sage` int(10) NOT NULL,
  `address` varchar(255) NOT NULL,
  PRIMARY KEY (`sid`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='员工管理';

-- ----------------------------
-- Records of sys_empl
-- ----------------------------
INSERT INTO `sys_empl` VALUES ('1', '李白', '12', '召唤师峡谷');
...
-- ----------------------------
INSERT INTO `sys_logininfor` VALUES ('100', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 7', '0', '登录成功', '2020-07-31 15:07:47');
INSERT INTO `sys_logininfor` VALUES ('101', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 7', '0', '退出成功', '2020-07-31 15:11:20');
INSERT INTO `sys_logininfor` VALUES ('102', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 7', '0', '登录成功', '2020-07-31 15:11:38');
INSERT INTO `sys_logininfor` VALUES ('103', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 7', '1', '验证码错误', '2020-07-31 15:23:19');
INSERT INTO `sys_logininfor` VALUES ('104', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 7', '0', '登录成功', '2020-07-31 15:23:23');
INSERT INTO `sys_logininfor` VALUES ('105', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 7', '0', '登录成功', '2020-07-31 15:34:51');
INSERT INTO `sys_logininfor` VALUES ('106', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 7', '0', '登录成功', '2020-07-31 16:00:08');
INSERT INTO `sys_logininfor` VALUES ('107', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 7', '0', '登录成功', '2020-07-31 16:01:43');
INSERT INTO `sys_logininfor` VALUES ('108', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 7', '0', '登录成功', '2020-07-31 16:21:42');
INSERT INTO `sys_logininfor` VALUES ('109', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 7', '0', '登录成功', '2020-07-31 16:42:29');
INSERT INTO `sys_logininfor` VALUES ('110', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 7', '0', '登录成功', '2020-07-31 16:52:26');
INSERT INTO `sys_logininfor` VALUES ('111', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 7', '1', '验证码错误', '2020-07-31 17:15:52');
INSERT INTO `sys_logininfor` VALUES ('112', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 7', '0', '登录成功', '2020-07-31 17:15:56');
INSERT INTO `sys_logininfor` VALUES ('113', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 7', '0', '登录成功', '2020-07-31 17:19:29');
INSERT INTO `sys_logininfor` VALUES ('114', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 7', '0', '登录成功', '2020-07-31 17:20:43');
INSERT INTO `sys_logininfor` VALUES ('115', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 7', '0', '登录成功', '2020-07-31 17:22:20');
INSERT INTO `sys_logininfor` VALUES ('116', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 7', '0', '登录成功', '2020-07-31 17:22:45');
INSERT INTO `sys_logininfor` VALUES ('117', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 7', '0', '登录成功', '2020-07-31 17:23:34');
INSERT INTO `sys_logininfor` VALUES ('118', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 7', '0', '退出成功', '2020-07-31 17:30:46');
INSERT INTO `sys_logininfor` VALUES ('119', 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 7', '0', '登录成功', '2020-07-31 17:32:55');
...
INSERT INTO `sys_menu` VALUES ('2007', '人员管理', '1', '3', '/system/empl', 'menuItem', 'C', '0', 'system:empl:view', 'fa fa-address-book', 'admin', '2020-07-31 17:12:01', '', null, '');
INSERT INTO `sys_menu` VALUES ('2008', '员工管理查询', '0', '1', '#', '', 'F', '0', 'system:empl:list', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES ('2009', '员工管理新增', '0', '2', '#', '', 'F', '0', 'system:empl:add', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES ('2010', '员工管理修改', '0', '3', '#', '', 'F', '0', 'system:empl:edit', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES ('2011', '员工管理删除', '0', '4', '#', '', 'F', '0', 'system:empl:remove', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES ('2012', '员工管理导出', '0', '5', '#', '', 'F', '0', 'system:empl:export', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '103', 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '/profile/avatar/2020/07/31/0f9ac095-d2ae-4e47-b902-f39b5d19137c.png', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2020-07-31 17:32:55', 'admin', '2018-03-16 11:33:00', 'ry', '2020-07-31 17:34:17', '管理员');
...
-- ----------------------------
INSERT INTO `sys_user_online` VALUES ('1a58d175-27ef-4760-af39-58ea82d7e963', 'admin', '研发部门', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 7', 'on_line', '2020-07-31 17:32:47', '2020-07-31 17:34:02', '1800000');
INSERT INTO `sys_user_online` VALUES ('37040c4e-0f25-4836-b99a-a1437b91e5a6', 'admin', '研发部门', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 7', 'on_line', '2020-07-31 17:20:37', '2020-07-31 17:22:20', '1800000');
INSERT INTO `sys_user_online` VALUES ('7ab1f919-f863-4811-834d-9d0a29fe5178', 'admin', '研发部门', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 7', 'on_line', '2020-07-31 16:52:22', '2020-07-31 17:12:01', '1800000');
INSERT INTO `sys_user_online` VALUES ('daa2c1f1-b66b-4b1e-bba6-0e8cb3ea9b5f', 'admin', '研发部门', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 7', 'on_line', '2020-07-31 17:15:45', '2020-07-31 17:15:56', '1800000');
INSERT INTO `sys_user_online` VALUES ('e6eff2a8-bb8b-4897-b458-51e918562b3e', 'admin', '研发部门', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 7', 'on_line', '2020-07-31 17:19:24', '2020-07-31 17:19:29', '1800000');
